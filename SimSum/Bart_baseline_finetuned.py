...
class BartBaseLineFineTuned(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
      ...
      p.add_argument('-TrainBS','--train_batch_size',type=int, default=20)
      p.add_argument('-ValidBS','--valid_batch_size',type=int, default=20)
      ...
      p.add_argument('-NumEpoch','--num_train_epochs',default=15)
...
class TrainDataset(Dataset):
    ...
    def _load_data(self):
        ...
        # self.inputs = self.inputs[:96]
        # self.targets = self.targets[:96]
    def __len__(self):
...
def train(args):
    ...
    model = BartBaseLineFineTuned.load_from_checkpoint("/home/tejadhith/Project/NLP/easy-summary/SimSum/experiments/exp_BART_WIKI_AUTO_REDUCED1714017271855759/checkpoint-epoch=1.ckpt")
