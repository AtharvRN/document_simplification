...
from preprocessor import EXP_DIR,WIKI_AUTO_REDUCED,WIKI_AUTO_REDUCED_CONTROL
import time
import json
...
def get_experiment_dir(create_dir=False):
    dir_name  = "SIMSUM_WIKI_AUTO_REDUCED_CONTROL"
...
# dataset = WIKI_AUTO_REDUCED
dataset = WIKI_AUTO_REDUCED_CONTROL
